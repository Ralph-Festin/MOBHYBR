...
namespace finals.Services
{
    public class CurrencyApiService
    {
        ...
        public async Task<LatestRatesResponse> GetLatestRatesAsync(string @base, string symbols = "")
        {
            var response = await _httpClient.GetFromJsonAsync<LatestRatesResponse>($"{BaseUrl}/latest?base={@base}&symbols={symbols}");
