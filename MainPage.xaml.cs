    ...
    public partial class MainPage : ContentPage
    {
        ...
        private async void LoadRates()
        {
            try
            {
                ...
                var latest = await _currencyService.GetLatestRatesAsync(baseCurrency, "USD, EUR, JPY, AUD, CAD");
                
                LatestDate.Text = $"Latest Exchange Rates (as of {latest.Date.ToString()})";
